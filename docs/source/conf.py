# -*- coding: utf-8 -*-
#
# OAR documentation build configuration file, created by
...
project = u'OAR'
copyright = u'2003 - %d, Laboratoire d\'Informatique de Grenoble (http://www.liglab.fr)' % YEAR
...
version_file = os.path.join(HERE, '..', '..',
                            "sources", "core", "common-libs", "lib",
                            "OAR", "Version.pm")

# The full version, including alpha/beta/rc tags.
_release = re.search("my \$OARVersion = \"([^'].*?)\"", open(version_file).read().strip()).group(1)
...
# for dirpath, dirnames, filenames in os.walk(os.path.join(HERE, "commands")):
#     for f in filenames:
#         if f.endswith('.rst'):
