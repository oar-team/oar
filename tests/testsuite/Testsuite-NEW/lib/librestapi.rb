...
class OarApis
attr_accessor :jobhash, :statushash, :specificjobdetails, :oarv, :oartz, :jobarray, :deletehash #chnge1
...
def initialize()
apiuri = "http://kameleon:kameleon@localhost/oarapi-priv" #chnge2
...
#
# Result: We use the JSON format and the 'simple' data structure
#
########################################################################
...
if !@oartz.is_a?(Hash) or @oartz.empty? #chnge3
...
if !@jobarray.is_a?(Array) or @jobarray.empty? #chnge5
...
if !@jobarray.is_a?(Array) or @jobarray.empty?
...
if !@resources.is_a?(Array) or @resources.empty?
...
if !@resourcedetails.is_a?(Array) or @resourcedetails.empty?
...
if !@noderesources.is_a?(Array) or @noderesources.empty?
...
########################################################################
#
# Method: create_resource(rhash)
#
# Usecase19: Create Resource
#
# Input: rhash
#
# Result: Returns details of created resources - resstatus
#
########################################################################
