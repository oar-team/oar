...
#
# Installé par olivier richard pour les besoins du site OAR
#
...
if ( $ENV{'REQUEST_METHOD'} =~ /GET/i )
{
   ...
   print "<CENTER><SMALL></SMALL></CENTER>\n";
   exit;
}
...
sub send_email
{
   ...
   {
      open (MAIL, "|$sendmail_path -f olivier.richard\@imag.fr -t");
   }
