...
rm) rm -rf m4 drmaa_utils autogen.sh config.h.in autom4te.cache scripts config.h config.log stamp-h1 Makefile.in Makefile libtool configure config.status aclocal.m4
    ;;
