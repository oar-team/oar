...
You can also request different groups of ressources, for example:

oarsub -l "{mem > 64}/host=1+{mem < 60}/host=3",walltime=1:00:00 -I

This will give 1 host with the property "mem" > 64 and 3 hosts with the property "mem" < 60.
The syntax inside {...} is the same used for "-p" option.
