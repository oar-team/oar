...
If I<duration> is given, the command requests the addition of that duration to the walltime of the job, or update a previous request.

If I<duration> is not given, the command shows the current extra time status for the job.
