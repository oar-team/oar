...
=item * the functionnality may be configured differently from one queue to another.
...
Request walltime increase to be applied at once: immediatly and not incrementally.
