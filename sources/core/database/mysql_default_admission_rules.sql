...
INSERT IGNORE INTO admission_rules (priority, enabled, rule) VALUES (2, 'YES', '# Prevent users oar and root to submit jobs
...
INSERT IGNORE INTO admission_rules (priority, enabled, rule) VALUES (3, 'YES', '# Avoid the jobs to go on resources in drain mode
$jobproperties_applied_after_validation = "drain=\\\'NO\\\'";
');

# Avoid users except admin to go in the admin queue
INSERT IGNORE INTO admission_rules (priority, enabled, rule) VALUES (4, 'YES', '# Restrict the admin queue to members of the admin group
...
INSERT IGNORE INTO admission_rules (priority, enabled, rule) VALUES (5, 'YES', '# Prevent users from using internal resource properties for oarsub requests 
...
INSERT IGNORE INTO admission_rules (priority, enabled, rule) VALUES (6, 'YES', '# Tie the besteffort queue, job type and resource property together
...
INSERT IGNORE INTO admission_rules (priority, enabled, rule) VALUES (7, 'YES', '# Prevent besteffort advance-reservation
...
INSERT IGNORE INTO admission_rules (priority, enabled, rule) VALUES (8, 'YES', '# Only advance-reservation jobs can be of type container
