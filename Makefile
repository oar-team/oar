...
draw-gantt:
	...
	install -d -m 0755 $(OARCONFDIR)
	@if [ -e $(CGIDIR)/drawgantt.conf ]; then echo "Warning: $(CGIDIR)/drawgantt.conf already exists, not overwriting it." ; else install -m 0600 DrawGantt/drawgantt.conf $(CGIDIR) ; fi
