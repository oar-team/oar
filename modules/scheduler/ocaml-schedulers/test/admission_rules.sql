...
# $Id: default_admission_rules.sql 1504 2008-07-11 20:32:51Z neyron $
...
# For testing purpose add deploy type (execute job only on deploy server)
INSERT IGNORE INTO admission_rules (rule) VALUES ('
	push(@{$type_list},"deploy");
	print("[ADMISSION RULE] Add deploy type.\\n");
');
...
INSERT IGNORE INTO admission_rules (rule) VALUES ('
my @bad_resources = ("type","state","next_state","finaud_decision","next_finaud_decision","state_num","suspended_jobs","cpuset","besteffort","deploy","expiry_date","desktop_computing","last_job_date","available_upto","scheduler_priority");
