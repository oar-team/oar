...
resubmit_prev_job_id INT UNSIGNED DEFAULT 0,
resubmit_next_job_id INT UNSIGNED DEFAULT 0,
INDEX state (state),
...
INSERT IGNORE INTO admission_rules (rule) VALUES ('if (($queue_name eq "admin") && ($user ne "oar")) {$queue_name="default";}');
...
INSERT IGNORE INTO queues (queue_name, priority, scheduler_policy) VALUES ('default','2','oar_sched_gantt');
INSERT IGNORE INTO queues (queue_name, priority, scheduler_policy) VALUES ('deploy','1','oar_sched_gantt');
